...
var kFields_comprobantes = {
    ...
    subTotal: { editable: false, type: "number" },
    tipoCambio: { editable: false, type: "number" },
    ...
    totalImpuestosTrasladados: { editable: false, type: "number" },
    totalImpuestosRetenidos: { editable: false, type: "number" },
