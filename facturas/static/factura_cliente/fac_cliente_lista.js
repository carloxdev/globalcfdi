...
if (url.pathname.search("smart") > 0) {
    url_grid = url.origin + "/smart/api/facturas_cliente/"
}
else {
    url_grid = url.origin + "/api/facturas_cliente/"
}
...
TargetaResultados.prototype.init = function () {
    ...
    this.kColumns = [
        ...
        { field: "emisor_rfc", title: "Receptor RFC", width: "200px", hidden: true },
        { field: "emisor_nombre", title: "Receptor Nombre", width: "200px", hidden: true },        
